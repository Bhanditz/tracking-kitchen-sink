 ...
 * http://www.apache.org/licenses/LICENSE-2.0 */ 
 ?>
 <link href="atn-simple-cart/css/main.css" rel="stylesheet"/> <div id="cart-container">
	<div class="col-md-7">
		...
		if(file_exists("atn-simple-cart/products.xml"))
		{
			$file="atn-simple-cart/products.xml";
		}
		else
		{
		...
		<br/><br/>
		 <div class="panel panel-default cart-panel">
			<div class="panel-heading">
				<img class="pull-left add-right-margin" height="20" src="atn-simple-cart/images/cart-m.png"/>
...
<div id="payment-container">
	...
	<form id="payment-from" action="atn-simple-cart/process_order.php" target="ajax-ifr">
	...
	?>
		...
		<img src="atn-simple-cart/images/paypal.png" alt="Payment through PayPal.com"/>
	<?php
	}
...
<iframe id="ajax-ifr" name="ajax-ifr" src="atn-simple-cart/empty.html" class="no-visibility" width="1" height="1"> </iframe>

<script src="atn-simple-cart/js/atn-cart.js"></script>
